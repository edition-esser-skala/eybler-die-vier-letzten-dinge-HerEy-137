...
GroßIstAlto = {
  \relative c' {
    \clef treble
    \key c \minor \time 2/2 \autoBeamOff \tempoGroßIst
    r2 g'\f
    r g
    fis fis4 c'
    h2 r \noBreak
...
GroßIstAltoLyrics = \lyricmode {
  ...
  und Raum
  in Zeit und
  Raum ſchloß er ſie %20
  ein, er ſchuf die
  Welt, und ſchloß in
  Zeit und Raum ſie
  ein, und ſchloß in
  Zeit und Raum ſie %25
  ein, und ſchloß ſie
  ein in
  Zeit und
  Raum
  ...
  ein in
  Zeit __ und
  Raum ſchloß er ſie %45
  ein, in Zeit und
  Raum __ in __
  Zeit und
  Raum, er ſchloß in
  Zeit und Raum ſie %50
  ein er ſchloß in
  Zeit und Raum ſie
  ein, in Raum __
  _ _ _
...
JehovahNahtAlto = {
  \relative c' {
    ...
    r2 r4 r8 b\pp \noBreak
    as8 r16 as as8 r16 as as4 r\fermata \bar "||" %60
    R1*2
    r2 r4\fermata r
...
JehovahNahtAltoLyrics = \lyricmode {
  Je -- %9
  ho -- vah naht!
